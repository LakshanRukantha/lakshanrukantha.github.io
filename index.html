...
<html lang="en">
  ...
  <body id="to-top">
    <nav class="navbar navbar-expand-lg fixed-top">
      <div class="container">
        <a class="navbar-brand" href="index.html">LR</a>
        ...
        <div class="collapse navbar-collapse collapse-bg" id="navbarNav">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-card-item">
              <a class="nav-link js-scroll-trigger" href="#bio">My bio</a>
            </li>
            <li class="nav-card-item">
          ...
          <ul class="navbar-nav ms-auto">
            <a
              class="btn cv-download btn-success py-2 px-4 text-nowrap"
              href=""
    ...
    <div class="loader"><svg class="loading-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin: auto; background: #22222200; display: block;" width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
      <path fill="none" stroke="#68d372" stroke-width="8" stroke-dasharray="128.29446411132812 128.29446411132812" d="M24.3 30C11.4 30 5 43.3 5 50s6.4 20 19.3 20c19.3 0 32.1-40 51.4-40 C88.6 30 95 43.3 95 50s-6.4 20-19.3 20C56.4 70 43.6 30 24.3 30z" stroke-linecap="round" style="transform:scale(0.8);transform-origin:50px 50px">
        <animate attributeName="stroke-dashoffset" repeatCount="indefinite" dur="1s" keyTimes="0;1" values="0;256.58892822265625"></animate>
      </path>
      </svg>
    <h6 class="loading-text">Lakshan Is Thinking...
    </h6></div>
      ...
      <main>
        ...
        <section id="intro">
          ...
          >
            <div class="text">
              ...
              <p>
                My name is <span id="intro-p">Lakshan Rukantha.</span> I'm a
                <span id="intro-p">Student</span> &
                <span id="intro-p">Multi-Talented Person</span> in
                <a
                  class="intro-p-url"
                  ...
                  >Sri Lanka.</a
                >
                I like working on the <span id="intro-p">Front-End</span> of the
                web.
              </p>
              <div class="intro-btns">
                <a class="btn btn-success py-2" href="#"
                  ><img
                    style="
                      width: 20px;
                    ...
                    "
                    src="img/icon/download-solid.svg"
                    alt=""
                  />Download CV</a
                >
                <a class="btn btn-outline-success py-2" href="#contact"
                  ><img style="width: 20px" src="img/icon/email.svg" alt="" />
        ...
        <section id="about">
          ...
          >
            ...
            <div class="about-wrapper">
              <div class="left">
                <div>
                  <img src="img/icon/woman-icon.svg" alt="" />
                  <h2><span class="green">2 Years</span> Job Experience</h2>
                </div>
                <div>
                  <img src="img/icon/projects-icon.svg" alt="" />
                  <h2><span class="green">08+</span> Projects Completed</h2>
                </div>
              </div>
              <div class="right">
                <h1>
                ...
                <p>
                  I’m an empathetic person who’s skilled at relating to people and
                  making them feel heard. As well as I’m very collaborative and
                  have always preferred to work in groups. I have a solid work
                  ethic. When I'm working on a project, I don't just want to meet
                  deadlines. Rather, I prefer to complete the project well ahead
                  of schedule. I pride myself on my problem-solving skills and my
                  ability to resolve potentially difficult situations.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="bio">
          ...
          >
            ...
            <div class="text">
              ...
              <p>
                Hi, I’m Lakshan Rukantha based in Sri Lanka. I am a Freelance
                Front-End Developer. I love Programming Languages & learn about
                New Technologies. I look forward to learning something new in my
                free time.
              </p>
            </div>
          </div>
        ...
        <section id="skills" class="text-center">
          ...
          >
            ...
            <h1>My skill <span class="green">levels</span></h1>
            <div class="skills-progress">
              <div class="skill-wrapper progress-95">
              ...
              <div class="skill-wrapper progress-75">
              ...
              <div class="skill-wrapper progress-64">
                <span class="label">64<span class="smaller">%</span></span>
                <div class="progress">
                  <div class="left-side half-circle"></div>
                  <div class="right-side half-circle"></div>
                </div>
                <div class="shadow"></div>
                <span class="skill-name">Sound Designing</span>
              </div>
              <div class="skill-wrapper progress-85">
        ...
        <section id="experience" class="text-center">
          <div
            ...
            data-aos-delay="200"
          >
            <h6 class="section-title">My previous jobs</h6>
            <h1>My <span class="green">Experience</span></h1>
            <div class="jobs">
              <div class="job-item first">
                <p class="date">October 2021 - January 2022</p>
                <p class="position">Retail Cashier</p>
                <p class="company">John Keells Holdings (PLC)</p>
                <p class="Duties-Res">Duties & Responsibilities</p>
                <div class="duties-coll">
                  <ul>
                    ...
                    <li>
                      Calculate and return change when required by the payment
                      method.
                    </li>
                    <li>
                      Maintain adequate change denominations in the cash drawer
                      and request additional change.
                    </li>
                    <li>Answer customer questions about products or services.</li>
                    <li>Reconcile cash drawers and sales receipts.</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        >
          <style>
            ...
            @keyframes pathAnim-0 {
              0% {
                d: path(
                  "M 0,400 C 0,400 0,200 0,200 C 63.06410256410257,245.6948717948718 126.12820512820514,291.3897435897436 219,265 C 311.87179487179486,238.6102564102564 434.551282051282,140.1358974358974 510,145 C 585.448717948718,149.8641025641026 613.6666666666666,258.0666666666667 679,266 C 744.3333333333334,273.9333333333333 846.7820512820515,181.59743589743587 939,167 C 1031.2179487179485,152.40256410256413 1113.2051282051282,215.54358974358976 1195,234 C 1276.7948717948718,252.45641025641024 1358.397435897436,226.2282051282051 1440,200 C 1440,200 1440,400 1440,400 Z"
                );
              }
              25% {
                d: path(
                  "M 0,400 C 0,400 0,200 0,200 C 59.02307692307693,174.23846153846154 118.04615384615386,148.4769230769231 197,161 C 275.95384615384614,173.5230769230769 374.8384615384615,224.33076923076922 469,222 C 563.1615384615385,219.66923076923078 652.6000000000001,164.2 732,162 C 811.3999999999999,159.8 880.7615384615383,210.86923076923077 963,231 C 1045.2384615384617,251.13076923076923 1140.3538461538462,240.3230769230769 1222,230 C 1303.6461538461538,219.6769230769231 1371.8230769230768,209.83846153846156 1440,200 C 1440,200 1440,400 1440,400 Z"
                );
              }
              50% {
                d: path(
                  "M 0,400 C 0,400 0,200 0,200 C 61.72564102564101,174.16153846153847 123.45128205128202,148.32307692307694 203,148 C 282.548717948718,147.67692307692306 379.92051282051284,172.86923076923074 473,205 C 566.0794871794872,237.13076923076926 654.8666666666667,276.20000000000005 733,270 C 811.1333333333333,263.79999999999995 878.6128205128206,212.33076923076922 944,189 C 1009.3871794871794,165.66923076923078 1072.6820512820511,170.4769230769231 1155,177 C 1237.3179487179489,183.5230769230769 1338.6589743589743,191.76153846153846 1440,200 C 1440,200 1440,400 1440,400 Z"
                );
              }
              75% {
                d: path(
                  "M 0,400 C 0,400 0,200 0,200 C 88.1820512820513,194.46923076923076 176.3641025641026,188.93846153846152 255,196 C 333.6358974358974,203.06153846153848 402.7256410256409,222.7153846153846 491,232 C 579.2743589743591,241.2846153846154 686.7333333333333,240.20000000000002 754,231 C 821.2666666666667,221.79999999999998 848.3410256410258,204.48461538461538 918,189 C 987.6589743589742,173.51538461538462 1099.902564102564,159.86153846153846 1194,162 C 1288.097435897436,164.13846153846154 1364.0487179487181,182.06923076923078 1440,200 C 1440,200 1440,400 1440,400 Z"
                );
              }
              100% {
                d: path(
        ...
        <section id="contact" class="text-center">
          ...
          >
            ...
            <h1>Call or write <span class="green">anytime</span></h1>
            <div class="row">
              <div class="form col-md-7 col-lg-8">
                <form id="contact-form" action="" method="post">
                  ...
                  <button type="submit" class="btn btn-success py-2 px-">
                    Send Message
                  </button>
                </form>
              </div>
              <div class="img col-md-5 col-lg-4">
                <img class="contact-img" src="img/photo-contact.jpg" alt="" />
              </div>
              <div
                class="contacts img col-xl-8"
                data-aos="zoom-in"
              ...
              >
                <div class="social-media">
                  ...
                  <a href="" class="me-2 text-reset"
                    ><img src="img/icon/instagram-icon.svg" alt=""
                  /></a>
                  <a href="" class="me-2 text-reset"
                    ><img src="img/icon/facebook-icon.svg" alt=""
                  /></a>
                  <a href="" class="me-2 text-reset"
                    ><img src="img/icon/twitter-icon.svg" alt=""
                  /></a>
                  <a href="" class="me-2 text-reset"
                    ><img src="img/icon/linkedin-icon.svg" alt=""
                  /></a>
                </div>
                <div class="email">
                  <p>E-Mail :</p>
                  <p class="white">rukanthalakshan@gmail.com</p>
                </div>
                <div class="phone">
                  <p>Phone Number :</p>
                  <p class="white">+94 76 372 1373</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="copyright">
            <p>
              ...
              <a
                ...
                >Lakshan Rukantha</a
              >
              <span id="heart-icon">&#10084;</span> | All rights reserved.
            </p>
            <!--
